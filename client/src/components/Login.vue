<template>
  ...
  <div class="field">
    ...
    <div class="form-group">
      <input v-model="login.username" type="text" required="required" />
      <label for="input" class="control-label">Name</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <input v-model="login.password" type="password" required="required" />
      <label for="input" class="control-label">Password</label><i class="bar"></i>
    </div>
    <div class="button-container">
      <button type="button" v-on:click.prevent="getLogin()" class="button"><span>Submit</span></button>
    </div>
    <p>Sign Up <span><router-link v-bind:to="'signup'" >HERE</router-link></span></p>
  </div>
  </div>
</template>
<script>
